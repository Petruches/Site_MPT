...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => 'GunTake',//Yii::$app->name,
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; GunTake <?= date('Y') ?></p>
